...
var show_aero_data_window = func {
 ...
 aero_data_window.add("fdm/jsbsim/propulsion/engine/thrust-lbs");
...
var show_prop_data_window = func {
 prop_data_window.add("fdm/jsbsim/aero/qbar-psf");
 prop_data_window.add("fdm/jsbsim/aero/alpha-deg");
 prop_data_window.add("fdm/jsbsim/velocities/vc-kts");
 prop_data_window.add("fdm/jsbsim/velocities/vtrue-kts");
 prop_data_window.add("fdm/jsbsim/velocities/mach");
 prop_data_window.add("fdm/jsbsim/attitude/theta-deg");
 prop_data_window.add("fdm/jsbsim/propulsion/engine/thrust-lbs");
 prop_data_window.add("fdm/jsbsim/inertia/weight-lbs");
 prop_data_window.add(props.globals.getNode("fdm/jsbsim/systems/test").getChildren());
}

close_data_windows = func { aero_data_window.close(); 
                             jet_data_window.close();
                            prop_data_window.close(); }
